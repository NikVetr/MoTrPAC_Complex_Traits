...
if(estimate_trait_corr_mats){
  ...
  # save(trait_corr_mats, file = paste0("~/data/smontgom/trait_corr_mat", ifelse(use_random_Pred_genes, "_random-genes", ""), ".RData"))  
} else {
  # load(file = paste0("~/data/smontgom/trait_corr_mat", ifelse(use_random_Pred_genes, "_random-genes", ""), ".RData"))
}
