...
#        "--expression-matrix /Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/gtex-pipeline/GTEx_Analysis_v8_eQTL_expression_matrices/Muscle_Skeletal.v8.normalized_expression.bed.gz  ",
#        "--columns 4,1,2,5 ",
#        "--exp-bfile /Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/gtex-pipeline/expression_genotypes/GTEx_v8 ",
#        "--geno-bfile /Users/nikgvetr/repos/ldsc/1000G_EUR_Phase3_plink/1000G.EUR.QC.1 ",
#        "--chr 1 ",
#        "--covariates /Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/gtex-pipeline/GTEx_Analysis_v8_eQTL_covariates/Muscle_Skeletal.v8.covariates.txt ",
#        "--out testrun"
# )
# 
#   
...
# covf <- fread("/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/gtex-pipeline/GTEx_Analysis_v8_eQTL_covariates/Muscle_Skeletal.v8.covariates.txt")
...
# covf <- covf[,-1]
# famf <- fread("/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/gtex-pipeline/expression_genotypes/GTEx_v8_noChr.fam")
# covf <- cbind(famf[match(rownames(covf), unlist(famf[,2])),1:2], covf)
# colnames(covf)[1:2] <- c("FID", "IID")
# fwrite(covf, "/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/mesc/GTEx_covariates/Muscle_Skeletal.v8.covariates.txt", sep = "\t", row.names = F, col.names = T)
...
# load("/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/internal/node_metadata_list.RData") #from "~/scripts/montgomery_lab/motrpac-DEG_barbeira-twas_intersection.R"
if(file.exists("/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/internal/node_metadata_list_mesc.RData")){
  load("/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/internal/node_metadata_list_mesc.RData")
} else {
  ...
  save(node_metadata_list, file = "/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/internal/node_metadata_list_mesc.RData")
}
...
mesc_compatible_genesets <- lapply(setNames(tissues, tissues), function(tiss){
  if(!file.exists(paste0("/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/GTEx_v8_ExpressionScores/tissues/", 
  ...
  mesc_genes <- unlist(lapply(1:22, function(cri) fread(paste0("/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/GTEx_v8_ExpressionScores/tissues/", 
...
geneset_dir <- "/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/mesc/genesets/"
...
output_dir <- "/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/mesc/output/Expression_Scores/"
if(!dir.exists(output_dir)){dir.create(output_dir)}
command_setup <- paste0("source ~/.bash_profile; cd /Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/mesc/; source activate mesc; ")
...
# for(tiss in tissues_to_analyze){
  ...
  tissue_dir <- paste0("/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/mesc/output/Expression_Scores/", tiss)
...
gwas_dir <- "/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/ldsc/gwas_sumstats/proper_format/"
...
foreach(tiss = tissues_to_analyze) %dopar% {
  ...
  tissue_dir <- paste0("/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/mesc/output/Enrichment/", tiss)
  if(!dir.exists(tissue_dir)){dir.create(tissue_dir)}
...
tissues_to_analyze <- list.files("/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/mesc/output/Enrichment/")
mesc_output_basic <- do.call(rbind, lapply(tissues_to_analyze, function(tiss){
  print(tiss)
  tissue_dir <- paste0("/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/mesc/output/Enrichment/", tiss, "/")
  mesc_out <- do.call(rbind, lapply(gwas_files, function(gwas){
...
fwrite(x = mesc_output_basic, file = "/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/internal/mesc_out_basic.txt")
...
# bim_file <- fread("/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/gtex-pipeline/expression_genotypes/GTEx_v8_noChr.bim")
# fwrite(bim_file, "/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/gtex-pipeline/expression_genotypes/GTEx_v8_noChr_noRSID.bim", col.names = F)
bim_file <- fread("/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/gtex-pipeline/expression_genotypes/GTEx_v8_noChr_noRSID.bim")
...
fwrite(bim_file_rsids, "/Volumes/2TB_External/MoTrPAC_Complex_Traits/data/external/gtex-pipeline/expression_genotypes/GTEx_v8_noChr.bim", col.names = F, sep = "\t")
